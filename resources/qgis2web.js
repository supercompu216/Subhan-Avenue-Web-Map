...
map.getView().fit([7454220.956253, 3531697.759956, 7456460.979405, 3533015.331606], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Subhan Avenue Map</h2>';
        return titleElement;
    })(),
